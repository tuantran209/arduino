...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin(client,"http://192.168.0.101/final/getdata.php");;  //--> Specify request destination
    ...
    // Example : http.begin("http://192.168.0.0/ESP32_MySQL_Database/Final/updateDHT11data_and_recordtable.php");
     http.begin(client,"http://192.168.0.101/final/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
