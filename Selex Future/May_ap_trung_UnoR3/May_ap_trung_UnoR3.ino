...
int statusmode1=0;//trạng thái của mode 1
...
/* Chuyển từ format BCD (Binary-Coded Decimal) sang Decimal */// từ khóa BCD
int bcd2dec(byte num) {
  return ((num / 16 * 10) + (num % 16));
}
/* Chuyển từ Decimal sang BCD *///thập phân sang BCD
